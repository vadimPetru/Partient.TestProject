...
public class Error : IEquatable<Error>
{
    ...
    /// </summary>
    public static readonly Error None = new(string.Empty, string.Empty,HttpStatusCode.Accepted);

    /// <summary>
    /// Represents an error for a null value.
    /// </summary>
    public static readonly Error NullValue = new("Error.NullValue", "The specified result value is null.", HttpStatusCode.Accepted);
    /// <summary>
